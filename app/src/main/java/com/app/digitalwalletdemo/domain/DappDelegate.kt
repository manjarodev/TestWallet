package com.app.digitalwalletdemo.domain
...
object DappDelegate : AppKit.ModalDelegate, CoreClient.CoreDelegate {
    ...
    override fun onConnectionStateChange(state: Modal.Model.ConnectionState) {
        Log.e("mmTAG", "onConnectionStateChange($state)")
        scope.launch {
    ...
    override fun onError(error: Modal.Model.Error) {
        Log.e("mmTAG", error.throwable.stackTraceToString())
        scope.launch {
    ...
    override fun onPairingState(pairingState: Core.Model.PairingState) {
        Log.e("mmTAG", "Dapp pairing state: ${pairingState.isPairingState}")
    }
}